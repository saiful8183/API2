...
public class UserTests {
	...
	public void TestPostuser() {
		...
		Response response = UserEndPointsRoutesImplimentataion.creatUser(userPaylod);
	...
	public void testGetUserByName() {
		...
		Response response = UserEndPointsRoutesImplimentataion.readUser(this.userPaylod.getUsername());
		response.then().log().all();
	...
	public void TestUpdateuserByName() {
		...
		Response response = UserEndPointsRoutesImplimentataion.UpdateUser(this.userPaylod.getUsername(), userPaylod);
		...
		Response responseafterUpdate = UserEndPointsRoutesImplimentataion.readUser(this.userPaylod.getUsername());
		response.then().log().all();
	...
	public void testDeleteUserByName() {
		...
		Response response = UserEndPointsRoutesImplimentataion.DeleteUser(this.userPaylod.getUsername());
